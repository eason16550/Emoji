...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-[#06C755] hover:bg-[#05b34d] text-white shadow-sm", // LINE Green
    secondary: "bg-gray-800 hover:bg-gray-700 text-white",
    outline: "border-2 border-gray-200 hover:border-[#06C755] hover:text-[#06C755] text-gray-600 bg-white",
